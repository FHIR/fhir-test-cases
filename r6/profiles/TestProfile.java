package org.hl7.fhir.services.profiles;
...
public class TestProfile extends PEGeneratedBase {
  ...
  @BindingStrength("example") @ValueSet("http://hl7.org/fhir/ValueSet/observation-codes-observationorboth")
  ...
  @Min("0") @Max("1") @Doco("This observation organizes/groups a set of sub-observations")
  @Definition("This observation serves as an organizer or grouper for a set of (one or more) sub-observations.")
  private boolean organizer;  // This observation organizes/groups a set of sub-observations

  @Min("0") @Max("1") @Doco("Healthcare event during which this observation is made. If you need to place the observation within one or more episodes of care, use the workflow-episodeOfCare extension")
  @Definition("The healthcare event  (e.g. a patient and healthcare provider interaction) during which this observation is made.")
  private Reference encounter;  // Healthcare event during which this observation is made. If you need to place the observation within one or more episodes of care, use the workflow-episodeOfCare extension
  ...
  public void load(PEInstance src) {
    ...
    if (src.hasChild("organizer")) {
      organizer = ((BooleanType) src.child("organizer").asDataType()).getValue();
    }
  ...
  public void save(PEInstance tgt, boolean nulls) {
    ...
    if (true) { // for now, at least
      tgt.makeChild("organizer").data().setProperty("value", new BooleanType(organizer));
    }
    tgt.clear("encounter");
    if (encounter != null) {
  ...
  public TestProfile setOrganizer(boolean value) {
    this.organizer = value;
    return this;
  }

  public boolean hasOrganizer() {
    return true; // not organizer != false ?
  }
